...
type Transaction struct {
	...
	TopUpId         uint    `gorm:"type:uuid;not null" json:"top_up_id,omitempty"`
	TransferId      uint    `gorm:"type:uuid;not null" json:"transfer_id,omitempty"`
	PaymentId       uint    `gorm:"type:uuid;not null" json:"payment_id,omitempty"`
